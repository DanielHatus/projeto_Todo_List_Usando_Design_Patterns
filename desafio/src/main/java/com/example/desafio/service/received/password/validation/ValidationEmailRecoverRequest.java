package com.example.desafio.service.received.password.validation;
...
@Component
@Slf4j
public class ValidationEmailRecoverRequest {
    private final UserRepository repository;

    public ValidationEmailRecoverRequest(UserRepository repository) {
